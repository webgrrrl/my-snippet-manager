...
A simple snippet manager for VS Code that lets you save, organise, and reuse code snippets across any programming language. Save your frequently used code blocks and insert them with a single click!
...
![My Snippet Manager screenshot (v1.0.0)](media/demo-image-v1.0.0.png)
